...
from apps.accounts.questionnaire.models import Question, QuestionOption, TargetGender, SectionType
    ...
    def handle(self, *args, **options):
        ...
        questions_data = [{'gender': 'groom',
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': "Islomiy tarbiya, namoz va Qur'on ta'limi."},
                                       {'letter': 'B',
                                        'text': 'Zamonaviy bilimlar, erkin fikrlash va dunyoviy muvaffaqiyat.'},
                                       {'letter': 'C', 'text': 'Sport, jismoniy va ruhiy matonat.'},
                                       {'letter': 'D', 'text': 'Kattalarga bo‘ysunish va so‘zsiz intizom.'}]},
                          {'gender': 'groom',
                           'section': 'religious_spiritual',
                           'order': 6,
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Moliya meniki bo‘lgani uchun bir o‘zim qaror qilaman.'},
                                       {'letter': 'B',
                                       ...
                                       {'letter': 'D', 'text': 'Kimning g‘oyasi yoki puli bo‘lsa, o‘sha hal qiladi.'}]},
                          {'gender': 'groom',
                           'section': 'financial_governance',
                           'order': 12,
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'C', 'text': 'O‘zi ham ishga kirib, ro‘zg‘orga pul olib kelishini.'},
                                       {'letter': 'D',
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'C', 'text': 'To‘ydan darhol alohida uyda (yoki ijarada) yashaymiz.'},
                                       {'letter': 'D',
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'Kim haq bo‘lsa, o‘shaning tarafida bo‘laman.'}]},
                          {'gender': 'groom',
                           'section': 'relatives_relations',
                           'order': 15,
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'Ayollar o‘zi kelishib olsin deb aralashmayman.'}]},
                          {'gender': 'groom',
                           'section': 'relatives_relations',
                           'order': 16,
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'Bu masalani cheklamayman, o‘zi hal qiladi.'}]},
                          {'gender': 'groom',
                           'section': 'relatives_relations',
                           'order': 18,
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'Vaqt o‘zi hammasini joyiga solishini kutaman.'}]},
                          {'gender': 'groom',
                           'section': 'character_crisis',
                           'order': 21,
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Meni yolg‘iz qoldirishini va tegmasligini.'},
                                       {'letter': 'B',
                                        'text': "Yonimda bo‘lib, tinglashini va ma'naviy dalda berishini."},
                                       {'letter': 'C', 'text': 'Hissiyotlarga berilmay, amaliy maslahat berishini.'},
                                       {'letter': 'D', 'text': 'Kayfiyatimni ko‘taradigan biror narsa qilishini.'}]},
                          {'gender': 'groom',
                           'section': 'character_crisis',
                           'order': 24,
                           ...
                           'is_trap': False,
                           'options': [
                               {'letter': 'A', 'text': 'Darhol va issig‘ida hammasini ochiq-oydin gaplashib olish.'},
                               {'letter': 'B',
                               ...
                               {'letter': 'D', 'text': 'Vaqt o‘tishi bilan unutilib ketishini kutish.'}]},
                          {'gender': 'groom',
                           'section': 'future_plans',
                           'order': 25,
                           'text': 'To‘ydan keyin farzand ko‘rish borasidagi rejangiz?',
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Iloji boricha tezroq (Alloh qachon bersa).'},
                                       {'letter': 'B',
                                        'text': '1-2 yil bir-birimizni tushunib, moliyaviy barqarorlashib keyin.'},
                                       {'letter': 'C', 'text': 'Avval karyera/maqsadlarni amalga oshirib, keyin.'},
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Qattiqqo‘llik, intizom va diniy ruhiyat.'},
                                       {'letter': 'B',
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [
                               {'letter': 'A', 'text': 'Uy ishlari — to‘liq ayolning vazifasi, men aralashmayman.'},
                               {'letter': 'B',
                          ...
                          {'gender': 'groom',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Uyda, ayolim va oilam davrasida tinchlikda.'},
                                       {'letter': 'B', 'text': 'Sayohatlarda, tabiat qo‘ynida va faol tarzda.'},
                                       {'letter': 'C', 'text': 'Ota-onam va qarindoshlarimni ziyorat qilish bilan.'},
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'C', 'text': 'Psixologik salomatlik va profilaktika juda muhim.'},
                          ...
                          {'gender': 'groom',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'B', 'text': 'Shaxsiy uy-joy, mashina va moliyaviy erkinlik.'},
                                       {'letter': 'C',
                          ...
                          {'gender': 'bride',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': "Diniy ta'lim va go‘zal Islomiy axloq."},
                                       {'letter': 'B',
                          ...
                          {'gender': 'bride',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': "Vaziyatga qarab, kimgadir mas'uliyat topshiriladi."}]},
                          {'gender': 'bride',
                           'section': 'financial_governance',
                           'order': 7,
                          ...
                          {'gender': 'bride',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Erkak kishi sifatida erim bir o‘zi qaror qiladi.'},
                                       {'letter': 'B',
                                       ...
                                       {'letter': 'D', 'text': 'Pul kimniki bo‘lsa, qarorni ham o‘sha qabul qiladi.'}]},
                          {'gender': 'bride',
                           'section': 'financial_governance',
                           'order': 12,
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'C', 'text': "O‘zim ishga kirib, ro‘zg‘orni va erimni ta'minlayman."},
                                       {'letter': 'D',
                          ...
                          {'gender': 'bride',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'O‘z ota-onamga aytib, ularni aralashtiraman.'}]},
                          {'gender': 'bride',
                           'section': 'relatives_relations',
                           'order': 15,
                          ...
                          {'gender': 'bride',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': 'Uy ishlaridan bo‘shaganimizdagina boraman.'}]},
                          {'gender': 'bride',
                           'section': 'relatives_relations',
                           'order': 18,
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': "Urf-odatlarga unchalik e'tibor bermayman."}]},
                          {'gender': 'bride',
                           'section': 'character_crisis',
                           'order': 19,
                          ...
                          {'gender': 'bride',
                           ...
                           'options': [
                               ...
                               {'letter': 'B',
                                'text': 'Hissiyotlar va jahl bosilgach, 1-2 kundan keyin bosiqlik bilan gaplashish.'},
                               {'letter': 'C', 'text': 'Uchinchi shaxs orqali hal qilish.'},
                               {'letter': 'D', 'text': 'Vaqt o‘tishi bilan o‘zi unutilib ketishini kutish.'}]},
                          {'gender': 'bride',
                           'section': 'future_plans',
                           'order': 25,
                           'text': 'To‘ydan keyin farzand ko‘rish borasidagi xohishingiz/rejangiz?',
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Iloji boricha tezroq (Alloh qachon bergan kuni).'},
                                       {'letter': 'B',
                          ...
                          {'gender': 'bride',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': "Qattiqqo‘llik va qat'iy intizom orqali."},
                                       {'letter': 'B',
                          ...
                          {'gender': 'bride',
                           ...
                           'is_trap': False,
                           'options': [{'letter': 'A', 'text': 'Uyda, erim va oilamiz davrasida tinchlikda.'},
                                       {'letter': 'B', 'text': 'Tabiat qo‘ynida, sayohatlarda va faol tarzda.'},
                                       {'letter': 'C',
                          ...
                          {'gender': 'bride',
                           ...
                           'options': [{'letter': 'A',
                                       ...
                                       {'letter': 'D', 'text': "Bunga alohida vaqt va e'tibor ajratmayman."}]},
                          {'gender': 'bride',
                           'section': 'future_plans',
                           'order': 30,
                           'text': 'Oila qurganingizdan 5 yil o‘tib, eng katta yutug‘ingiz nima bo‘lishini xohlaysiz?',
